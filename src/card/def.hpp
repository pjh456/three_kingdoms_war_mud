...
namespace tkw
{
    namespace card
    {
        ...
        enum class CardEffectKind : std::uint8_t
        {
            ...
            Chain,         /**< 铁索连环：对一至两名角色分别横置/重置 */
            FireAttack,    /**< 火攻：目标展示一张手牌，使用者可弃同花色手牌造成火焰伤害 */
        };
        ...
        enum class Ability : std::uint8_t
        {
            ...
            Cixiong,               /**< 雌雄双股剑：杀唯一目标且目标异性时可发动，目标二选一（弃一手牌 / 令使用者摸一张） */
            ...
            FireShaConvert,        /**< 朱雀羽扇：普通杀使用时可当具火焰伤害的杀 */
        };
        ...
        enum class Scope : std::uint8_t
        {
            ...
            AllOthers, /**< 所有其他角色 */
            All,       /**< 所有角色（含自己） */
            OneOrTwo,  /**< 一至两名角色（含自己；铁索连环） */
            AnyOne,    /**< 任意一名角色（含自己；火攻，须有手牌） */
        };
