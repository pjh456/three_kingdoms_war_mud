...
namespace tkw
{
    namespace game
    {
        ...
        inline bool JudgeQuery::has_same_delayed(
            const ReadOnlyContext &ctx, const std::string &entity,
            const std::string &def_id)
        {
        ...
        inline std::string JudgeQuery::next_delayed_target(
            const ReadOnlyContext &ctx, const std::string &player,
            const std::string &def_id)
        {
        ...
        inline bool JudgeQuery::is_delayed_scope_target(
            const ReadOnlyContext &ctx, const std::string &player,
            const card::CardDef &def, const std::string &target)
        {
        ...
        inline std::vector<std::string> JudgeQuery::delayed_legal_targets(
            const ReadOnlyContext &ctx, const std::string &player,
            const card::CardDef &def)
        {
